...
/**
 * Project card with fixed height, 3D tilt, spotlight effect, and proper link handling
 */
export const ProjectCard = React.memo<ProjectCardProps>(
  ({ project, index }) => {
    ...
    return (
      <motion.div
        ref={ref}
        className="group relative rounded-xl overflow-hidden backdrop-blur-glass bg-glass-white border border-neon-cyan/20 hover:border-neon-cyan/50 transition-all duration-300 cursor-pointer flex flex-col h-full"
        variants={scaleIn}
        initial="hidden"
        ...
        style={{
          ...
          perspective: "1000px",
          minHeight: "520px", // Fixed minimum height for consistency
        }}
      >
        {/* Dynamic spotlight */}
        {isHovering && (
        ...
        {/* Project preview area - Fixed height */}
        <div className="relative h-56 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden flex-shrink-0">
        ...
        <div className="p-6 relative z-10 flex flex-col flex-grow">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {project.technologies.length > 5 && (
              <NeonBadge variant="gradient" size="sm">
                +{project.technologies.length - 5}
              </NeonBadge>
            )}
          </div>
          ...
          <div className="flex gap-3 mt-auto">
            {/* Primary button - GitHub or Demo Link */}
            {(project.githubUrl || project.link || project.demoUrl) && (
              <a
                href={
            ...
            {/* Secondary button - Show demo if both GitHub and demo exist */}
            {project.githubUrl && project.demoUrl && (
              <a
                ...
                rel="noopener noreferrer"
              >
                <NeonButton as="div" variant="ghost" size="sm">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
